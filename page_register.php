                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="register.php" method="post"> <!-- куда отправляем -->
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-4 ml-auto text-right">
                                                <button name="submit" id="js-login-btn" type="submit" class="btn btn-block btn-danger btn-lg mt-3">Регистрация</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
